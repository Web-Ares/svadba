( function() {
    ...
    $( function() {
        ...
        //
        //var Nice = new NiceRadio(null);
        //
        //Nice.core().refreshNew();
...
var Slider = function (obj) {
    ...
    NiceRadio.prototype = {
        ...
        refreshNew:function(){
            $('.steps').find('input[type="radio"]').each(function(){
        ...
        core: function(){
            ...
            return {
                ...
                controls: function(){
                    $('body').on('change','.steps__item-radio', function(){
                    ...
                    $('body').on('click','.nice-radio', function(){
